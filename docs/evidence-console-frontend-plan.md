...
`production_ready_for_fiber_method` must remain `false` unless separate testnet Fiber E2E evidence and operational hardening are present.
...
- Testnet evidence mode after operational hardening exists.
