...
Production readiness remains blocked after local-only Fiber evidence. The gate must keep `production_ready_for_fiber_method: false` until testnet Fiber E2E evidence and the Rust HTTP gateway production path are present.
